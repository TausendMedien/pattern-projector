...
export const baroqueSwirls: Pattern = {
  ...
  name: "Baroque Swirls",
  controls: [
    { label: "Band Count",   type: "range", min: 2,   max: 20,  step: 1,    get: () => bandCount,   set: (v) => { bandCount = v; } },
    ...
    { label: "Teal",         type: "range", min: 0.0, max: 1.5, step: 0.05, get: () => tealAmt,     set: (v) => { tealAmt = v; } },
    { label: "Purple",       type: "range", min: 0.0, max: 1.5, step: 0.05, get: () => purpleAmt,   set: (v) => { purpleAmt = v; } },
